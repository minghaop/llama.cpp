...
__kernel void flash_attn_f16(
    ...
    const global DATA_TYPE* mask_ptr_row =
        (mask_base != NULL && my_query_row < n_q)
            ? (const global DATA_TYPE*)(mask_base + my_query_row * mask_nb1)
            : NULL;
...
__kernel void flash_attn_f16_q1_splitk_stage1(
    const global void * q_void, ulong q_offset,
    const global void * k_void, ulong k_offset,
    const global void * v_void, ulong v_offset,
    global void * o_void, ulong o_offset,
...
__kernel void flash_attn_f16_q1_splitk_stage2(
