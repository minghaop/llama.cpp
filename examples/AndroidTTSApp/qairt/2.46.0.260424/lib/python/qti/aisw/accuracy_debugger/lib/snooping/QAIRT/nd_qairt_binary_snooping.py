...
from qti.aisw.accuracy_debugger.lib.utils.snooper_utils import handle_boolean_params_in_encodings, SnooperUtils as su
...
class QAIRTBinarySnooping(QAIRTSnooper):
    ...
    def _get_valid_ir_activations(self):
        handle_boolean_params_in_encodings(self._args.quantization_overrides)
