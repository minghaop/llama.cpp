...
class SQNRVerifier(BaseVerifier):
    ...
    def verify(self, layer_type, tensor_dimensions, golden_output, inference_output, save=True):
        ...
        if len(golden_raw) != len(inference_raw):
            ...
            return VerifyResult(layer_type, len(inference_raw), tensor_dimensions, SQNRVerifier.NAME, msg, "")
        ...
        return VerifyResult(layer_type, len(inference_raw), tensor_dimensions, SQNRVerifier.NAME, sqnr,
                            SQNRVerifier.UNITS)
