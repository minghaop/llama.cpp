    ...
    def verify_update_parsed_args(self, parsed_args):
        ...
        if qnn:
            ...
            if parsed_args.compiler_config or parsed_args.qnn_netrun_config_file or \
                ...
                if ('dsp' not in parsed_args.runtime and 'lpai' not in parsed_args.runtime and \
                    parsed_args.runtime not in [Runtime.gpu.value, Runtime.aic.value, Runtime.htp.value]):
        ...
        if qnn:
            ...
            if parsed_args.extra_converter_args:
                converter_ignore_list = [
                    ...
                    'use_per_channel_quantization', 'i', 'b',
