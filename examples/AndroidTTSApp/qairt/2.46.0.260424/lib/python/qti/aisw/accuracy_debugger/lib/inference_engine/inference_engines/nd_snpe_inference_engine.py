...
class SNPEInferenceEngine(InferenceEngine):
    ...
    class DLCData:
        ...
        def __init__(self, host_dlc_path, host_model_inputs, target_model_inputs):
    ...
    def _write_input_list(dlc_data, input_list_dir):
        ...
        dlc_data.host_input_list_path = os.path.join(input_list_dir, 'input_list.txt')
        string_to_write = ""
    ...
    def _push_libs(self):
        ...
        try:
            self.logger.info('Pushing dlc to target')
