...
converter_op_support = {
    ...
    "QNN_OP_CONV_3D": {ONNX: "Conv, QLinearConv", TENSORFLOW: "conv3d", TENSORFLOW_LITE: "conv_3d"},
    ...
    "QNN_OP_CUMULATIVE_SUM": {ONNX: "CumSum", TENSORFLOW: "cumsum", PYTORCH: "cumsum", TENSORFLOW_LITE: "cumsum"},
    ...
    "QNN_OP_TRANSPOSE_CONV_3D": {ONNX: "ConvTranspose", TENSORFLOW: "conv3d_transpose", TENSORFLOW_LITE: "transpose_conv3d"},
    ...
    "QNN_OP_ELEMENT_WISE_ATAN": {ONNX: "Atan", PYTORCH: "atan", TENSORFLOW_LITE: "atan2"},
    ...
    "QNN_OP_ELEMENT_WISE_SIGN": {ONNX: "Sign", PYTORCH: "sign", TENSORFLOW_LITE: "sign"},
    ...
    "QNN_OP_GELU": {ONNX: MATCHED+" / Gelu(for onnx version>=1.15)", TENSORFLOW: MATCHED, PYTORCH: "GELU", TENSORFLOW_LITE: "gelu"},
    ...
    "QNN_OP_RANDOM_UNIFORM_LIKE": {ONNX: "RandomUniformLike"},
