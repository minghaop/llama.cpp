...
class QAIRTCumulativeLayerwiseCmdOptions(QAIRTSnoopingCmdOptions):
    ...
    def initialize(self):
        ...
        self.parser = argparse.ArgumentParser(
            ...
            description="Script to run cumulative-layerwise-custom-override snooping.")
        ...
        self._optional_args.add_argument('--compulsory_override', default=None, required=False,
            help='override file containing encodings for the ops which has to be run in certain\
                 precision for each subgraph debugging. This is helpful incase one op is already\
