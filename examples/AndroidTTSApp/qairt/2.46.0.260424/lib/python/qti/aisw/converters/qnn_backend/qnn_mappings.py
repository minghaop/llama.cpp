...
custom_dtype_to_quant_dtype_map = {
    ir_graph.QNN_DATATYPE_UINT_8: ir_graph.QNN_DATATYPE_UFIXED_POINT_8,
    ir_graph.QNN_DATATYPE_INT_8: ir_graph.QNN_DATATYPE_SFIXED_POINT_8,
    ir_graph.QNN_DATATYPE_UINT_16: ir_graph.QNN_DATATYPE_UFIXED_POINT_16,
    ir_graph.QNN_DATATYPE_INT_16: ir_graph.QNN_DATATYPE_SFIXED_POINT_16,
}
