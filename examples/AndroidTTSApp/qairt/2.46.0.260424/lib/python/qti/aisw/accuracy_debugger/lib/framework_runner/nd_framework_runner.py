...
class FrameworkRunner(object):
    ...
    def __init__(self, logger, args):
        ...
        self._logger = logger
        self.use_native_output_files = args.use_native_output_files if hasattr(
            args, 'use_native_output_files') else False
    ...
    def generate_intermediate_outputs(self, output_dir, input=None,
        ...
        dump_intermediate_tensors(self.output_dir, result, self._logger,
                                  self.use_native_output_files)
        dump_profile_json(self.output_dir, result, self.use_native_output_files)
