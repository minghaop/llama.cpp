...
def get_ctype_from_qnn_type(qnn_type):
    return {
        ...
        QnnDatatype.QNN_DATATYPE_BFLOAT_16: 'float',
...
class EncodingMappingType(Enum):
    STANDARD_SYMMETRIC = 0
    ASYMMETRIC_PLUS_ONE = 1
    LINEAR_SYMMETRIC_EXCLUDE_ZERO = 2
    UNDEFINED = 3
...
class EncodingType(Enum):
    ...
    BW_AXIS_SCALE_OFFSET_MAPPED = 4
    BW_BLOCK_MAPPED = 5
    BW_BLOCKWISE_EXPANSION_MAPPED = 6
    MICROSCALING = 7
...
class QnnDatatype(Enum):
    ...
    QNN_DATATYPE_BFLOAT_16 = 23
    QNN_DATATYPE_INT_2 = 24
    QNN_DATATYPE_INT_4 = 25
    QNN_DATATYPE_UINT_2 = 26
    QNN_DATATYPE_UINT_4 = 27
    QNN_DATATYPE_FLOAT_4 = 28
    QNN_DATATYPE_FLOAT_8 = 29
    QNN_DATATYPE_SFIXED_POINT_2 = 30
    QNN_DATATYPE_UFIXED_POINT_2 = 31

    @classmethod
    def get_types(cls, category='integer'):
        values = list(cls.__members__.values())
        if category == 'integer':
            return values[2:6] + values[24:26]
        elif category == 'float':
            return values[10:12] + values[20] + values[28:30]
        elif category == 'unsigned':
            return values[6:10] + values[26:28]
        elif category == "signed_quantized":
            return values[12:15] + values[22] + values[30]
        elif category == "unsigned_quantized":
            return values[15:18] + values[21] + values[31]
        elif category == "bool":
            return values[18]
...
class NativeDatatype(Enum):
    ...
    BFLOAT_16 = QnnDatatype.QNN_DATATYPE_BFLOAT_16
    ...
    INT_2 = QnnDatatype.QNN_DATATYPE_INT_2
    INT_4 = QnnDatatype.QNN_DATATYPE_INT_4
    UINT_2 = QnnDatatype.QNN_DATATYPE_UINT_2
    UINT_4 = QnnDatatype.QNN_DATATYPE_UINT_4
    FLOAT_4 = QnnDatatype.QNN_DATATYPE_FLOAT_4
    FLOAT_8 = QnnDatatype.QNN_DATATYPE_FLOAT_8
    SFIXED_POINT_2 = QnnDatatype.QNN_DATATYPE_SFIXED_POINT_2
    UFIXED_POINT_2 = QnnDatatype.QNN_DATATYPE_UFIXED_POINT_2
...
class QuantParam:
    def __init__(self, encodings, bitwidth, axis, symmetric, scale, offset, min, max, math_invariant, mapping, float_encoding, scale_datatype):
        self.__encodings = []
        ...
        self.__float_encoding = None
        self.float_encoding = float_encoding
        self.__scale_datatype = None
        self.scale_datatype = scale_datatype
    ...
    def mapping(self, value):
        if value == None or isinstance(value, EncodingMappingType):
            self.__mapping = value
        else:
            raise TypeError(f"Attempting to add EncodingMappingType {value} that is not valid")

    @property
    def float_encoding(self):
        return self.__float_encoding

    @float_encoding.setter
    def float_encoding(self, value):
        if value == None or isinstance(value, FloatEncodingType):
            self.__float_encoding = value
        else:
            raise TypeError(f"Attempting to add FloatEncodingType {value} that is not valid")

    @property
    def scale_datatype(self):
        return self.__scale_datatype

    @scale_datatype.setter
    def scale_datatype(self, value):
        if value == None or isinstance(value, QnnDatatype):
            self.__scale_datatype = value
        else:
            raise TypeError(f"Attempting to add QnnDatatype {value} that is not valid")
...
class InputElement(ActivationTensorElement):
    ...
    def __init__(self, name, description, mandatory, default, datatype, rank,
                 shape, layout=Layout.UNDEFINED, constraints=[], repeated=False,
                 dynamic_shape="", is_static_tensor=False, is_quantizable=False):
        super().__init__(name=name, description=description, mandatory=mandatory,
                         default=default, datatype=datatype, rank=rank, shape=shape,
                         layout=layout, constraints=constraints, repeated=repeated,
                         dynamic_shape=dynamic_shape)
        self.is_static_tensor = is_static_tensor
        self.is_quantizable = is_quantizable
...
class EnumElement(RankZeroElement):
    ...
    def check_datatype(self, dtype):
        if(dtype == QnnDatatype.QNN_DATATYPE_FLOAT_16 or
           dtype == QnnDatatype.QNN_DATATYPE_BFLOAT_16 or
           dtype == QnnDatatype.QNN_DATATYPE_FLOAT_32 or
           dtype == QnnDatatype.QNN_DATATYPE_FLOAT_64):
...
class OpDefCollection:
    ...
    def __init__(self, use_qhpi=False):
        self.op_def_dict = OrderedDict()
        self.supplemental_op_def = {}
        self.supported_ops = {}
        self.use_qhpi = use_qhpi
