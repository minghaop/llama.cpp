...
from qti.aisw.converters.common.utils.converter_utils import (
    ...
    log_warning,
    log_error,
    convert_args_dict_to_namespace
)
...
class TFConverterFrontend(ConverterFrontend):
    ...
    def __init__(self, args: Union[Namespace, dict], *, custom_op_factory=None, validator=None):
        """
        Initialize a new instance of TFConverterFrontend class.
        ...
        """
        # Convert args dict to TFConverterFrontend Namespace instance
        ...
        self.summary = args.tf_summary if hasattr(args, "tf_summary") else False
        ...
        if args.enable_framework_trace:
            log_warning("The framework op trace is not supported for tensorflow converter. Hence disable this argument in current running.")
            args.enable_framework_trace = False

    def summarize_model(self):
        """
        :rtype: FrameworkSummary
        """
