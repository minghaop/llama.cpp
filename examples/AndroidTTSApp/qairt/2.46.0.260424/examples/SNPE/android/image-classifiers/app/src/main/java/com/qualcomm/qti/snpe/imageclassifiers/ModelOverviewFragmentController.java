...
import com.qualcomm.qti.snpe.imageclassifiers.tasks.ClassifyImageWithUserBufferTf16Task;
        ...
        if (mNeuralNetwork != null) {
            ...
            switch (mNetworkTensorFormat) {
                case UB_TF8:
                    ...
                    break;
                case UB_TF16:
                    task = new ClassifyImageWithUserBufferTf16Task(this, mNeuralNetwork, bitmap, mModel);
                    break;
                case FLOAT:
                default:
