...
/**
 * Terminates runtime/backend resources.
 *
 * It is recommended to call this API when all SNPE instaces have de-initialized
 *
 ...
 */
SNPE_API
int Snpe_Util_CleanupRuntime(Snpe_Runtime_t runtime, uint32_t deviceId);
