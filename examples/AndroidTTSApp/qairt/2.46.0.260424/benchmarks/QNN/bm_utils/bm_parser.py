...
class ArgsParser(object):
    def __init__(self, program_name, args_list):
        ...
        optional.add_argument('--dsp_type', help='Specify DSP variant for QNN BM run',
                              required=False,
                              choices=['v65', 'v66', 'v68', 'v69', 'v69-plus', 'v73', 'v75', 'v79', 'v81','v85'], default=None)
        ...
        optional.add_argument('--qnn_system_info_path', required=False,default=None, action="store",
                          help=" path to qnn_system_info dll for windows")
    ...
    @property
    def qnn_system_info_path(self):
        return self._args['qnn_system_info_path']
