...
llama_context::llama_context(
    ...
    cparams.flash_attn = params.flash_attn_type != LLAMA_FLASH_ATTN_TYPE_AUTO;
...
llm_graph_result * llama_context::process_ubatch(const llama_ubatch & ubatch, llm_graph_type gtype, llama_memory_context_i * mctx, ggml_status & ret, int dot_debug) {
    if (mctx && !mctx->apply()) {
