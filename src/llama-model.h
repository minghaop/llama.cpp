...
struct llama_model {
    ...
    // CosyVoiceFlow
    struct ggml_tensor * inp_embed_w      = nullptr;
    struct ggml_tensor * spk_embed_w      = nullptr;
    struct ggml_tensor * spk_embed_b      = nullptr;
    struct ggml_tensor * after_norm_w     = nullptr;
    struct ggml_tensor * after_norm_b     = nullptr;
    struct ggml_tensor * embed_out_0_w    = nullptr;
    struct ggml_tensor * embed_out_0_b    = nullptr;
    struct ggml_tensor * embed_out_1_w    = nullptr;
    struct ggml_tensor * embed_out_1_b    = nullptr;
    struct ggml_tensor * pre_look_conv1_w = nullptr;
    struct ggml_tensor * pre_look_conv1_b = nullptr;
    struct ggml_tensor * pre_look_conv2_w = nullptr;
    struct ggml_tensor * pre_look_conv2_b = nullptr;
    struct ggml_tensor * up_layer_conv_w  = nullptr;
    struct ggml_tensor * up_layer_conv_b  = nullptr;
    struct ggml_tensor * up_embed_out_0_w = nullptr;
    struct ggml_tensor * up_embed_out_0_b = nullptr;
    struct ggml_tensor * up_embed_out_1_w = nullptr;
    struct ggml_tensor * up_embed_out_1_b = nullptr;
    struct ggml_tensor * encoder_proj_w   = nullptr;
    struct ggml_tensor * encoder_proj_b   = nullptr;
    struct ggml_tensor * time_mlp_1_w     = nullptr;
    struct ggml_tensor * time_mlp_1_b     = nullptr;
    struct ggml_tensor * time_mlp_2_w     = nullptr;
    struct ggml_tensor * time_mlp_2_b     = nullptr;
    struct ggml_tensor * down_blk_mlp_w   = nullptr;
    struct ggml_tensor * down_blk_mlp_b   = nullptr;
    struct ggml_tensor * down_blk1_conv_w = nullptr;
    struct ggml_tensor * down_blk1_conv_b = nullptr;
    struct ggml_tensor * down_blk1_norm_w = nullptr;
    struct ggml_tensor * down_blk1_norm_b = nullptr;
    struct ggml_tensor * down_blk2_conv_w = nullptr;
    struct ggml_tensor * down_blk2_conv_b = nullptr;
    struct ggml_tensor * down_blk2_norm_w = nullptr;
    struct ggml_tensor * down_blk2_norm_b = nullptr;
    struct ggml_tensor * down_blk_res_w   = nullptr;
    struct ggml_tensor * down_blk_res_b   = nullptr;
    struct ggml_tensor * down_blk_conv_w  = nullptr;
    struct ggml_tensor * down_blk_conv_b  = nullptr;
    struct ggml_tensor * up_blk_mlp_w     = nullptr;
    struct ggml_tensor * up_blk_mlp_b     = nullptr;
    struct ggml_tensor * up_blk1_conv_w   = nullptr;
    struct ggml_tensor * up_blk1_conv_b   = nullptr;
    struct ggml_tensor * up_blk1_norm_w   = nullptr;
    struct ggml_tensor * up_blk1_norm_b   = nullptr;
    struct ggml_tensor * up_blk2_conv_w   = nullptr;
    struct ggml_tensor * up_blk2_conv_b   = nullptr;
    struct ggml_tensor * up_blk2_norm_w   = nullptr;
    struct ggml_tensor * up_blk2_norm_b   = nullptr;
    struct ggml_tensor * up_blk_res_w     = nullptr;
    struct ggml_tensor * up_blk_res_b     = nullptr;
    struct ggml_tensor * up_blk_conv_w    = nullptr;
    struct ggml_tensor * up_blk_conv_b    = nullptr;
    struct ggml_tensor * f_blk_conv_w     = nullptr;
    struct ggml_tensor * f_blk_conv_b     = nullptr;
    struct ggml_tensor * f_blk_norm_w     = nullptr;
